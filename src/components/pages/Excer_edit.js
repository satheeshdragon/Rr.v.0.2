...
class Excer_edit extends Component {
  ...
  componentDidMount()
  {
    axios.get('https://sdnodeapi.herokuapp.com/exercises/'+this.props.match.params.id)
      .then(res => {
  ...
  onSubmit(e) {
    ...
    e.preventDefault();
     ...
     axios.post('https://sdnodeapi.herokuapp.com/exercises/update/'+this.props.match.params.id,exerc)
      .then(res => {
